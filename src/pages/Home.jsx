// Home.jsx --- CasaDividendes (Premium Restyle v3)
...
function HeroHome() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Redirection future vers page d'inscription
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12 py-12 text-center">
        <motion.div {...fadeUp(0.05)}>
          ...
          <button
            ...
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-orange-400 to-amber-400
          text-black font-semibold hover:brightness-110 transition-all shadow-[0_8px_30px_rgba(255,140,0,0.25)]"
          >
